      ...
      return (
       ...
       <div className={`phone-input ${isDarkMode ? 'dark-login' : 'light-login'}`} >
          <div dir="rtl" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <div className="form-group">  
            <span className="icon"><DriveFileRenameOutlineIcon style={{color: isDarkMode ? '#FFFFFF' : '#4C4343', }} /></span> {/* Phone icon */}  
            <input  
                type="text"  
                id="Name"  
                placeholder=" "  
        ...
        <div className={`phone-input ${isDarkMode ? 'dark-login' : 'light-login'}`} >
          <div dir="rtl" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>      
            <div className="form-group">  
            <span className="icon"><MarkEmailReadIcon style={{color: isDarkMode ? '#FFFFFF' : '#4C4343', }} /></span> {/* Phone icon */}  
            <input  
                type="tel"  
                id="phoneNumber"  
                placeholder=" "  
                autoComplete="off"  
                required  
                value={toPersianDigits(verificationCode.join(''))}  
                onChange={handleInputChange}  //chnage
                // className={error ? 'error' : ''} 
              />  
            <label htmlFor="phoneNumber" className={error ? 'error' : ''}>کد تایید</label>  
            </div> 
            </div>
          </div>
          <DialogTitle>
