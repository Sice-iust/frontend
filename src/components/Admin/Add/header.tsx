...
export default function AdminHeader() {
  return (
    <header className="flex justify-between items-center bg-white text-black  dark:bg-black dark:text-white p-4 shadow-lg">
      {/* Logo */}
      <div className="hidden md:flex flex-shrink-0 mr-auto">
            <Link href="/">
      ...
      <nav className="flex gap-6">
        ...
        <HeadsetMicOutlinedIcon className="text-[#F18825]"/></a>
        <a href="/AdminAddPage" className="hover:underline">ویرایش و افزودن</a>
        <span className=" items-start text-[#F18825]">
        ...
        <TextSnippetOutlinedIcon className="text-[#F18825]"/></a>
