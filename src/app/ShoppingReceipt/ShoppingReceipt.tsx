    ...
    if (loading) {
        return (
            <div className="relative">
                <div className={`box-content ml-10 mt-10 mb-10 min-h-140 w-100 rounded-2xl ${isDarkMode ? "bg-[#191919] border-white" : "bg-white"} `}>
                ...
                <div className={`absolute top-0 left-10 right-0 bottom-0 rounded-2xl flex items-center justify-center ${isDarkMode ? "bg-[#191919] border-white" : "bg-white"} bg-opacity-70`}>
                    <LoadingBox />
                </div>
            </div>
        );
                ...
                <>  
                    ...
                    <div className="p-5 flex flex-col pt-2">  
                        ...
                        <div className="flex flex-row-reverse py-2 border-t mt-6 justify-between">  
                            ...
                            <span className={`font-bold ${isDarkMode ? "text-white" : "text-black"} font-2xl`}>{convertToPersianNumbers(totalActualPrice.toLocaleString())}</span>  
